...
app.get('/', (req, res) => res.send("API Server for Think Tunes - Video Library"));

app.listen(process.env.PORT || port, () => console.log(`think-tunes app listening at http://localhost:${process.env.PORT}`));